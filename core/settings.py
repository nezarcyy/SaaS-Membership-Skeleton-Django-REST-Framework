...
SECRET_KEY = 'django-insecure-keh%a7he&+=-mb=2!-o2f8zq)d8$ede+q-um!7v5$@6d52+^@a'
...
DJOSER = {
    ...
    'EMAIL': {
        'activation': 'authentication.mailing.ActivationEmail',
        'confirmation': 'authentication.mailing.ConfirmationEmail',
    }
}
